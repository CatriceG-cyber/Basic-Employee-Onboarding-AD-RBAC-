...
## Problem Statement
The problem with this project was based on a fictional company called NorthStar Medical Group. They were dealing with a poor IT infrastructure because a third-party MSP setting up a disorganized identity infrastructure, which created several security and management issues. They had no RBAC policy in place and no audit trail, resulting in one of the main risks they were concerned about was violating HIPAA compliance because employees had different levels of access based on their roles. When an employee left the company, their access was not always disabled, creating a risk that someone could access confidential information. Additionally, employee accounts were set up manually within the infrastructure, and there was no documentation of their permissions or passwords.
